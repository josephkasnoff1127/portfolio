...
import githubdp from "@/public/ml.jpg";
...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Joseph Kasnoff.</span> I'm a{" "}
        <span className="font-bold">Senior Machine Learning engineer. </span>{" "}
        I'm currently working with LLMs and Voice Cloning.
      </motion.h1>
      ...
      >
        <a
          ...
          href="https://github.com/josephkasnoff1127"
          target="_blank"
        >
        ...
        {/* <a
          ...
          href="https://www.linkedin.com/in/Joseph-Kasnoff/"
          target="_blank"
        >
